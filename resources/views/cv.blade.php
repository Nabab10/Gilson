...
<body>
   ...
   <!-- Navbar Start -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ route('vitae') }}" class="nav-item nav-link active ">CV</a>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-4 animated slideInDown">Curriculum Vitae</h1>
                        ...
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="pdf/CV Nabab_080847.pdf" class="btn btn-primary py-3 px-5 mt-3">Telecharger le CV</a>
                                </div>
                            </div>
                        </div>
